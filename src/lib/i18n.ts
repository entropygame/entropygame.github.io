...
export const I18N: Record<Lang, Dict> = {
  en: {
    ...
    hero: {
      ...
      sub: "Command fleets. \nRecruit alien heroes. \nFight for the galaxy's last resources.",
      cta: "Play Now - Free",
  ...
  ru: {
    ...
    hero: {
      ...
      sub: "Командуйте флотами. \nВербуйте инопланетных героев. \nСражайтесь за последние ресурсы галактики.",
      cta: "Играть сейчас — бесплатно",
  ...
  de: {
    ...
    hero: {
      ...
      sub: "Befehlige Flotten. \nRekrutiere außerirdische Helden. \nKämpfe um die letzten Ressourcen der Galaxie.",
      cta: "Jetzt spielen – kostenlos",
  ...
  es: {
    ...
    hero: {
      ...
      sub: "Comanda flotas. \nRecluta héroes alienígenas. \nLucha por los últimos recursos de la galaxia.",
      cta: "Jugar ahora - gratis",
  ...
  th: {
    ...
    hero: {
      ...
      sub: "บัญชาการกองเรือ \nคัดเลือกฮีโร่ต่างดาว \nต่อสู้เพื่อทรัพยากรสุดท้ายของกาแล็กซี",
      cta: "เล่นเลย - ฟรี",
  ...
  id: {
    ...
    hero: {
      ...
      sub: "Pimpin armada. \nRekrut pahlawan alien. \nBerjuang untuk sumber daya terakhir galaksi.",
      cta: "Mainkan Sekarang - Gratis",
